...
.button-close {
 ...
 ``` ``` html <template> 
  ...
  <button :class="[$style.button, $style.buttonClose]">X</button> </template> <!-- Using CSS modules --> 
<style module>
.button {
  border: none;
  border-radius: 2px;
...
As for the `$` prefix, it's purpose within the Vue ecosystem is special instance properties that are exposed to the user, so using it for *private* properties would not be appropriate.
...
<div class="style-example example-bad">
  ...
  <!-- In DOM templates --><my-component/> ``` {% raw %}
</div>
...
<div class="style-example example-good">
  ...
  <!-- In DOM templates --><my-component></my-component> ``` {% raw %}
</div>
...
<div class="style-example example-bad">
  ...
  <!-- In single-file components and string templates --><mycomponent/> ``` ``` html 
  
  <!-- In DOM templates --><mycomponent></mycomponent> ``` {% raw %}
</div>
...
<div class="style-example example-good">
  ...
  <!-- In DOM templates --><my-component></my-component> ``` OR ``` html 
  
  <!-- Everywhere --><my-component></my-component> ``` {% raw %}
</div>
...
<style>/* ... */</style>
  ...
  <!-- ComponentB.vue --><template>...</template> 
<script>/* ... */</script>
 <style>/* ... */</style>
 ``` {% raw %}
</div>
